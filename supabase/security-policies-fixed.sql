-- ========================================
-- POLÍTICAS DE SEGURANÇA METALMA OS (VERSÃO CORRIGIDA)
-- ========================================
...
-- 2. POLÍTICAS PARA ADMINS (apenas admin pode gerenciar)
...
-- 3. POLÍTICAS PARA CLIENTES (todos podem ver, apenas admin pode gerenciar)
...
-- 4. POLÍTICAS PARA COLABORADORES (todos podem ver, apenas admin pode gerenciar)
...
-- 5. POLÍTICAS PARA PRODUTOS (todos podem ver, apenas admin pode gerenciar)
...
-- 6. POLÍTICAS PARA ORDENS DE SERVIÇO (todos podem gerenciar)
...
-- 7. POLÍTICAS PARA CONFIGURAÇÕES (apenas admin)
...
-- 11. FUNÇÃO DE VALIDAÇÃO DE ENTRADA
...
-- 13. ATIVAR RLS EM TODAS AS TABELAS
...
-- 15. VERIFICAR SE TUDO FOI APLICADO
