-- Script para criar a tabela de auditoria de login/logout
...
COMMENT ON TABLE public.auditoria_login IS 'Tabela para registrar todos os logins e logouts do sistema';
COMMENT ON COLUMN public.auditoria_login.tipo_evento IS 'Tipo do evento: login ou logout';
COMMENT ON COLUMN public.auditoria_login.user_agent IS 'Informações do navegador/dispositivo do usuário'; 