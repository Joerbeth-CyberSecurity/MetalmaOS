-- Script FINAL para corrigir problemas dos relatórios
...
WHERE table_name IN ('ordens_servico', 'colaboradores', 'os_tempo', 'produtos')
    AND column_name IN ('data_fim', 'tempo_execucao_real', 'tempo_parada', 'desconto_tipo', 'desconto_valor', 'observacoes', 'meta_hora', 'horas_calculadas', 'unidade')
